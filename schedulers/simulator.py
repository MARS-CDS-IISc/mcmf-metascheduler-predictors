...
class Simulator(object):
    ...
    def __init__(self, jobs, num_processors, scheduler, eventQueue, configuredMachine):
        #print 'Configuring simulator with', 'Jobs:', jobs, 'Nprocs:', num_processors, 'scheduler:', scheduler
        ...
        self.machine = configuredMachine
    ...
    def handle_submission_event(self, event):
        ...
        #self.event_queue.QueuedJobs.append(event.job)
        #print 'User submission job:', event.job.id
